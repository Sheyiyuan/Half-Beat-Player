...
export function ApplyExitChoice(arg1:string,arg2:boolean):Promise<void>;

export function BeforeExit():Promise<models.ExitAction>;
...
export function GetExitBehavior():Promise<string>;
...
export function SetExitBehavior(arg1:string):Promise<void>;

export function SetWindowManager(arg1:services.WindowManager):Promise<void>;
